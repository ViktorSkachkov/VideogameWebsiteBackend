...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(com.example.demo.configuration.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(com.example.demo.configuration.security.isauthenticated.IsAuthenticated)")
